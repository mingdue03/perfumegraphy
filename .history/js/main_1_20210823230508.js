$(document).ready( function(){
  ...
  $(window).resize(function(){
    ...
    if(winR>768){
      ...
      //mainslides
      $('#slides').css('width','640px','height','auto');
      $('.slidesjs-container').attr('overflow','hidden','position','relative','width','640px','height','700px');
      $('.slidesjs-control').attr('position', 'relative', 'left', '0px', 'width', '640px','height','700px');
