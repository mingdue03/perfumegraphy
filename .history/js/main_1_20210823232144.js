$(document).ready( function(){
  ...
  $(window).resize(function(){
    ...
    if(winR>768){
      ...
      //mainslides
      $('.visual').attr('style','width : 640px ; height : 700px');
      $('#slides').attr('style','width : 640px ; height : 700px');
      $('.slidesjs-container').attr('style','width : 640px; height : 700px');
      $('.slidesjs-control').attr('style','width : 640px; height : 700px');
