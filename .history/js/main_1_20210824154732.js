$(document).ready( function(){
  ...
  $(window).resize(function(){
    ...
    if(winR>1034){
      //mainslides
      $('.visual').css('width','1200px','height','800px');
      $('#slides').attr('style','overflow: hidden; display: block; width : 1200px ; height : 800px');
      $('.slidesjs-container').attr('style','overflow: hidden; position: relative; width : 1200px; height : 800px');
      $('.slidesjs-control').attr('style','position: relative; left: 0px; width : 1200px; height : 800px');
      ...
      //mainslides
      $('.visual').css('width','960px','height','700px');
      $('#slides').attr('style','overflow: hidden; display: block; width : 960px ; height : 700px');
      $('.slidesjs-container').attr('style','overflow: hidden; position: relative; width : 960px; height : 700px');
      $('.slidesjs-control').attr('style','position: relative; left: 0px; width : 960px; height : 700px');
      ...
      //css('width','640px','height','700px');
      //.attr('style','overflow: hidden; position: relative; width : 640px; height : 700px');
