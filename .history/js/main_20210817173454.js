...
//MONTH
var monthP =$('.month .month_product');
var proNumber=$('div.month_product').length;
var imgW=$('.month_product img').width();

monthP.css({'width':3*imgW});
setInterval(function(){
  monthP.animate({'margin-left':'-467px'},1000,function(){
    monthP.find('.month_product:nth-of-type(1)').insertAfter(monthP.find('.month_product:nth-of-type(3)'),monthP.css({'margin-left':'0'}))
  });
},1000)
