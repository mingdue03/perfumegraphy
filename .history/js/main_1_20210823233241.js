$(document).ready( function(){
  ...
  $(window).resize(function(){
    ...
    if(winR>768){
      ...
      //mainslides
      $('.visual').css('width','1440px','height','750px');
      $('#slides').attr('style','overflow: hidden; display: block; width : 1440px ; height : 750px');
      $('.slidesjs-container').attr('style','overflow: hidden; position: relative; width : 1440px; height : 750px');
      $('.slidesjs-control').attr('style','position: relative; left: 0px; width : 1440px; height : 750px');
